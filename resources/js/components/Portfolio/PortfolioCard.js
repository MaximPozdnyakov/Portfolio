    ...
    const technologiesRow = (
        <Row className="mt-4 px-2">
            {technologies.map((name, i) => (
                <Col key={name} xs={i <= 2 ? 4 : ""} className="px-2 mt-3">
                    <div className="bg-secondary br-20 d-flex justify-content-center align-items-center py-1">
                        {name}
                    </div>
                </Col>
            ))}
    ...
    return (
        <Card bg="white">
            ...
            <Card.Body className="text-center p-3">
                <Card.Title className="fw-600 fs-18">{title}</Card.Title>
                <Card.Text className=" text-center mt-2">{body}</Card.Text>
                {technologiesRow}
                <div className="mt-4 d-flex justify-content-between">
                    <Button
                        href={link}
                        variant="primary"
                        className="text-white fw-600 br-4 fs-18 visit-btn-p"
                    >
                        Visit
                    </Button>
                    <Button
                        ...
                        className="d-flex align-items-center br-4 fs-18 visit-btn-p"
                    >
                        <svg
                            width={16}
                            height={16}
